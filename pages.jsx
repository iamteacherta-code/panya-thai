...
const GAMES = [
  ...
  { en: "อักษร 3 หมู่", th: "Y1 · จัดหมู่พยัญชนะ กลาง/สูง/ต่ำ (ตอบทันที)", level: "intermediate", file: "interactive-consonant-class.html" },
  { en: "เลือกสระให้ถูก", th: "Y1 · สระพิเศษ & สระสั้น ไ ใ -ำ เ-า -ิ -ี -ุ (ตอบทันที)", level: "intermediate", file: "interactive-vowel-pick.html" },
  { en: "มาตราตัวสะกด", th: "Y1 · แยกคำเข้ามาตรา กง/กน/กม/เกย/เกอว (ตอบทันที)", level: "intermediate", file: "interactive-final-sort.html" },
